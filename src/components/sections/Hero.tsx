...
const Hero = () => {
  return (
    <Container className="h-[calc(100vh-64px)] grid place-content-center md:grid-cols-2 gap-8 md:gap-2 my-40 md:my-20">
      <motion.div
        variants={intro}
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        >
          Welcome to <span className="text-black font-bold">iRepair</span>, your
      ...
      >
        <img
          ...
          className="w-full max-w-[500px] rounded-sm md:-rotate-[30deg] md:ml-auto md:mr-[24px]"
        />
      </motion.div>
    </Container>
  );
